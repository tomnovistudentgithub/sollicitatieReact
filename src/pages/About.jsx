            ...
            <div className="about-page-container-header">
                ...
                <div className="about-page-inner-container">
                    ...
                    <div className="about-page-content-container">
                        ...
                        <p> Ik ben Tom, kom jullie wel eens tegen in de wandelgangen en bij de koffieautomaat ☕ </p>
                        <p> In mijn vrije tijd breng ik veel tijd door bij de poedelclub 🐩, verder zijn mijn hobbies: bingo, vissen en world of warcraft. </p>
                        <p> Maar even alle gekheid op een stokkie: ik ben serieus geinteresseerd in deze functie en in mijn CV en motivatie zal ik dat ook laten blijken </p>
                    </div>
                </div>
            </div>
